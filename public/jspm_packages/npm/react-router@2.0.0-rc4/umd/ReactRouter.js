...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexLink2 = __webpack_require__(29);
	...
	var _History2 = __webpack_require__(28);

	var _History3 = _interopRequireDefault(_History2);

	exports.History = _History3['default'];

	var _Lifecycle2 = __webpack_require__(32);

	var _Lifecycle3 = _interopRequireDefault(_Lifecycle2);

	exports.Lifecycle = _Lifecycle3['default'];

	var _RouteContext2 = __webpack_require__(34);
	...
	var _useRoutes2 = __webpack_require__(46);
	...
	var _RouterContext2 = __webpack_require__(20);
	...
	var _useRouterHistory2 = __webpack_require__(14);
	...
	var _browserHistory2 = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function routerWarning(falseToWarn, message) {
	  message = '[react-router] ' + message;
	   false ? _warning2['default'](falseToWarn, message) : undefined;
	}
	...
	function createTransitionManager(history, routes) {
	  ...
	  function isActive(location) {
	    ...
	    if (indexOnlyOrDeprecatedQuery && indexOnlyOrDeprecatedQuery !== true || deprecatedIndexOnly !== null) {
	       false ? _warning2['default'](false, '`isActive(pathname, query, indexOnly) is deprecated; use `isActive(location, indexOnly)` with a location descriptor instead: http://bit.ly/1VpTo9H') : undefined;
	...
	var Link = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var props = _objectWithoutProperties(_props2, ['to', 'query', 'hash', 'state', 'activeClassName', 'activeStyle', 'onlyActiveOnIndex']);
	     ...
	     false ? _warning2['default'](!(query || hash || state), 'the `query`, `hash`, and `state` props on `<Link>` are deprecated, use `<Link to={{ pathname, query, hash, state }}/>, see http://bit.ly/1VpTo9H.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DOMStateStorage = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var History = {
	  ...
	  componentWillMount: function componentWillMount() {
	     false ? _warning2['default'](false, 'the `History` mixin is deprecated, please access `context.router` with your own `contextTypes`. http://bit.ly/1QZCLCv') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lifecycle = {
	  ...
	  componentDidMount: function componentDidMount() {
	     false ? _warning2['default'](false, 'the `Lifecycle` mixin is deprecated, please use `context.router.setRouteLeaveHook(route, hook)`, see http://bit.ly/1PxKMv7 for more details.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouteContext = {
	  ...
	  componentWillMount: function componentWillMount() {
	     false ? _warning2['default'](false, 'The `RouteContext` mixin is deprecated. You can provide `this.props.route` on context with your own `contextTypes`. See http://bit.ly/1MHiOst') : undefined;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RouterContext = __webpack_require__(20);

	var _RouterContext2 = _interopRequireDefault(_RouterContext);

	var _RouteUtils = __webpack_require__(4);

	var _RouterUtils = __webpack_require__(21);
	...
	var Router = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    var stringifyQuery = _props2.stringifyQuery;
	     ...
	     false ? _warning2['default'](!(parseQueryString || stringifyQuery), '`parseQueryString` and `stringifyQuery` are deprecated. Please create a custom history. See http://bit.ly/1NRMoPX for details.') : undefined;
	  ...
	  wrapDeprecatedHistory: function wrapDeprecatedHistory(history) {
	    ...
	    if (history) {
	      ...
	      createHistory = function () {
	       ...
	       false ? _warning2['default'](false, '`Router` no longer defaults the history prop to hash history. Please use the `hashHistory` singleton instead. http://bit.ly/1ktRibg') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useRouterHistory = __webpack_require__(14);
